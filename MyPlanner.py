...
class CadastroFeito(tk.Frame):
    def __init__(self, app):
        ...
        #configurações do botão que leva a tela de tarefas arquivadas
...
class TarefasRealizadas(tk.Frame):
    def __init__(self, app):
        ...
        self.voltar = tk.Button(self) #botão para voltar pra tela principal
        self.voltar["text"] = "Voltar"
        self.voltar["font"] = ("Times New Roman", "15")
        self.voltar["command"] = self.app.mudar_tela_principal #diz qual função chamar quando clicarem no botão
